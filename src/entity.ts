...
//inför hitbox
  ...
  constructor(
    ...
    this.hitBoxRadius = Math.min(width, height) * 0.3; // Gör hitboxen mindre än själva objektet genom att ta den minsta av width och height, och sen multiplicera med 0.2
  }
